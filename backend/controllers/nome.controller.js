...
import { nomeService } from "../service/nome.service.js";
...
export class nomeController {
  ...
  pagaRecompensa(req, res) {
    ...
    const isAutentica = this.nomeService.validaAutenticacao(carta.autenticacao);
    ...
    const isRecompensaPaga = this.nomeService.pagaRecompensa(carta.valor);
